...
sources = {
    ...
    "ip_stream_us": {"url": "https://ruleset.skk.moe/sing-box/ip/stream_jp.json", "type": "route"},
    "stream_tw": {"url": "https://ruleset.skk.moe/sing-box/non_ip/stream_tw.json", "type": "route"},
    "ip_stream_us": {"url": "https://ruleset.skk.moe/sing-box/ip/stream_tw.json", "type": "route"},
