...
# 配置资源列表
# type: 'dns' 存入 source/dns/, 'route' 存入 source/route/
sources = {
    # --- DNS 分流 (需要从 .conf 转换) ---
    ...
    "geoip-cn": {"url": "https://raw.githubusercontent.com/MetaCubeX/meta-rules-dat/sing/geo/geoip/cn.json", "type": "route"},
    "geosite-cn": {"url": "https://raw.githubusercontent.com/MetaCubeX/meta-rules-dat/sing/geo/geosite/cn.json", "type": "route"},
    "geolocation-cn": {"url": "https://raw.githubusercontent.com/MetaCubeX/meta-rules-dat/sing/geo/geosite/geolocation-cn.json", "type": "route"},
    "geolocation-!cn": {"url": "https://raw.githubusercontent.com/MetaCubeX/meta-rules-dat/sing/geo/geosite/geolocation-!cn.json", "type": "route"},
    "geosite-gfw": {"url": "https://raw.githubusercontent.com/MetaCubeX/meta-rules-dat/sing/geo/geosite/gfw.json", "type": "route"},
}


def process_source(name, info):
    url = info["url"]
    folder = f"singbox/source/{info['type']}"
